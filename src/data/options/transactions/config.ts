...
rewardDestination: '...';
	...
	[OptionId.txDotExtraBond]: usage(["const tx = await k.dot.craftBondExtraTx('stash_account', 1);"], 'dot'),
	...
	[OptionId.txDotWithdraw]: usage(["const tx = await k.dot.craftWithdrawUnbondedTx('controller_account');"], 'dot'),
...
> = {
	...
	[OptionInputId.dotExtraBondAmount]: amount('DOT'),
